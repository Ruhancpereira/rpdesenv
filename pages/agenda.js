...
import { AppShellPage } from "@/lib/client-page-wrapper";
    ...
    <AppShellPage user={user}>
      ...
      <section className="ag-card">
        <div className="ag-card-body">
          ...
          <select className="ag-select" value={form.coreId} onChange={(e) => setForm((p) => ({ ...p, coreId: e.target.value }))} required>
          ...
          <select className="ag-select" value={form.moduleId} onChange={(e) => setForm((p) => ({ ...p, moduleId: e.target.value }))} required>
          ...
          <select className="ag-select" value={form.activityType} onChange={(e) => setForm((p) => ({ ...p, activityType: e.target.value }))}>
          ...
          <input className="ag-input" type="date" value={form.date} onChange={(e) => setForm((p) => ({ ...p, date: e.target.value }))} required />
          <div className="grid grid-cols-2 gap-2">
            <input className="ag-input" type="time" value={form.startTime} onChange={(e) => setForm((p) => ({ ...p, startTime: e.target.value }))} required />
            <input className="ag-input" type="time" value={form.endTime} onChange={(e) => setForm((p) => ({ ...p, endTime: e.target.value }))} required />
          </div>
          <input className="ag-input" type="number" step="0.5" min="0.5" value={form.allocatedHours} onChange={(e) => setForm((p) => ({ ...p, allocatedHours: Number(e.target.value) }))} />
          <select className="ag-select" value={form.location} onChange={(e) => setForm((p) => ({ ...p, location: e.target.value }))}>
          ...
          <input className="ag-input" value={form.city} onChange={(e) => setForm((p) => ({ ...p, city: e.target.value }))} placeholder="Cidade" />
          ...
          <select className="ag-select" value={form.agendaStatus} onChange={(e) => setForm((p) => ({ ...p, agendaStatus: e.target.value }))}>
          ...
          <input className="ag-input md:col-span-2" value={form.requester} onChange={(e) => setForm((p) => ({ ...p, requester: e.target.value }))} placeholder="Solicitante" />
          <textarea className="ag-textarea md:col-span-4" value={form.notes} onChange={(e) => setForm((p) => ({ ...p, notes: e.target.value }))} placeholder="Observações" />
